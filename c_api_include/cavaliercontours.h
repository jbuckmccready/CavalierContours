...
// will be closed.
CAVC_API cavc_pline *cavc_pline_new(cavc_vertex *vertex_data, uint32_t vertex_count, int is_closed);
...
CAVC_API uint32_t cavc_pline_capacity(cavc_pline *pline);
...
CAVC_API uint32_t cavc_pline_vertex_count(cavc_pline *pline);
...
CAVC_API void cavc_pline_vertex_data(cavc_pline *pline, cavc_vertex *vertex_data);

// Returns whether the cavc_pline is closed or not.
CAVC_API int cavc_pline_is_closed(cavc_pline *pline);
...
CAVC_API void cavc_pline_set_vertex_data(cavc_pline *pline, cavc_vertex *vertex_data,
...
CAVC_API uint32_t cavc_pline_list_count(cavc_pline_list *pline_list);
...
CAVC_API cavc_pline *cavc_pline_list_get(cavc_pline_list *pline_list, uint32_t index);
...
CAVC_API int cavc_parallel_offet(cavc_pline *pline, cavc_real delta, cavc_pline_list **output,
                                 int option_flags);
...
CAVC_API void cavc_combine_plines(cavc_pline *pline_a, cavc_pline *pline_b, int combine_mode,
                                  cavc_pline_list **remaining, cavc_pline_list **subtracted);

// Returns the path length of the cavc_pline given.
CAVC_API cavc_real cavc_get_path_length(cavc_pline *pline);
...
CAVC_API cavc_real cavc_get_area(cavc_pline *pline);
...
CAVC_API int cavc_get_winding_number(cavc_pline *pline, cavc_point point);
...
CAVC_API void cavc_get_extents(cavc_pline *pline, cavc_real *min_x, cavc_real *min_y,
...
CAVC_API void cavc_get_closest_point(cavc_pline *pline, cavc_point input_point,
